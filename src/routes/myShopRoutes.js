...
router.post("/products", protect, upload.array("images", 5), createMyProduct);
router.patch("/products/:id", protect, upload.array("images", 5), updateMyProduct);
router.put("/products/:id", protect, upload.array("images", 5), updateMyProduct);
